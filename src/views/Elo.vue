      ...
      <v-dialog v-model="shareDialog" width="500">
        ...
        <v-card>
          ...
          <template v-if="!isSharing">
            <v-card-subtitle>Since we don't store your passwords, you have to update them with SHARE button yourself anytime you want it update!</v-card-subtitle>
            ...
            <v-card-text>Czech translation and requestion deletion will be available in one or two days, or you can just reach me thru github!</v-card-text>
            <v-card-actions>
              <v-btn
                dark
